...
import {
  ...
  getAllCourseEnrollmentParamsSchema,
} from "./course-enrollment-schema.js";
...
class CourseEnrollmentRoutes extends BaseRoutes {
  routes() {
    this.router.get(
      ...
      validateQueryParamsCredentials(getAllCourseEnrollmentParamsSchema),
      tryCatch(courseEnrollmentController.getAll)
    );
