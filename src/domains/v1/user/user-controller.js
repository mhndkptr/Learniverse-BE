...
class UserController {
  ...
  async changePassword(req, res) {
    ...
    if (!requester) throw BaseError.unauthorized("Unauthorized");
    if (requester.id !== id) {
      throw BaseError.forbidden("You can only change your own password");
    }

    const data = await UserService.changePassword(id, req.body);
    return updatedResponse(res, data, "Password updated successfully");
  }
